                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            if(user.isEmailVerified()){
                                ...
                                Toast.makeText(LoginActivity.this, "Please verify you email, a verification email has been sent to you.", Toast.LENGTH_SHORT).show();
                            }

                        }else{
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(LoginActivity.this, "Failed to login. Please check your credentials then retry", Toast.LENGTH_LONG).show();
                        }
                    }
                });
